...
public abstract class BaseGeneratorUI extends JFrame {
    ...
    public JPanel imagePanel = null;

    public JButton clearImagesButton = null;
    ...
    private Object[][] constructors = new Object[][]{
            ...
            {"Редактор \"Задач на шахматы\"", ChessGenerator.class},
            {"separator", "separator"},
...
//    }
            ...
            addImageButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    if (JFileChooser.APPROVE_OPTION == result) {
                        ...
                        SetImage(getImageChooser().getSelectedFile());
                    }
     ...
     * @return javax.swing.JMenu
     */
    public JMenu getConstructorMenu() {
...
//            hide(imageChooser.getComponents(), 0);
    ...
    public void setActiveSave(File file) {
        ...
        if (prevSave == null) {
            saveToPrev.setEnabled(false);
            setTitle(getHelpString() + " - " + "новая задача");
        } else {
            saveToPrev.setEnabled(true);
            setTitle(getHelpString() + " - " + file.getName());
        }
    }
